                            ...
                            <div class="modal-wrapper">
                                <div class="modal-header">
                                    ...
                                    <div class="flex-center">
                                        <div>MannyJoubert</div>
                                        <div>.html</div>
                                    </div>
                                </div>
                                <div>
                                    <img class="imagecv" src="../images/MoiLeMoi.jpg" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        <h1 class="heading-jumbo">Manny Joubert</h1>
                        <div class="subhead space-bottom-36">c'est moi !</div>
                        <a href="projects.php" target="_blank" class="button w-button">Voir Mes Projets</a>
                    </div>
                </div>
            </div>

            <div class="containercv2">
                <div class="modal-wrapper">
                    <div class="modal-header">
                        <div class="button-circles-wrap"><a href="/" class="button-circle close w-inline-block"></a>
                            <div class="button-circle"></div>
                    ...
                    <div class="w-embed modal-body">
                        <h1>Mon Parcours Professionnel</h1>
                            <h3>Stage des écoles (2019)</h3>
                                <p>Stage réalisé à la base navale de Toulon dans le secteur du numérique et du multimédia.</p>
                            <h3>Alternance à l'école des sous-mariniers (SEPT. 2022 – SEPT. 2024)</h3>
                                <p>Développeur de simulateurs en C#, Xaml (.Net 7.0) avec quelques notions de SQL dans un modèle MVVM. <br />
                                    Participation à la création de simulateur de conduite de sous-marins nucléaire, <br/>
                                    D’un logiciel de formation aux oreilles d’or, <br />
                                    D’un serious game éducatif sur le métier de sous-marinier, <br />
                                    Et d’un simulateur de visualisation de fluides. <br />
                                    (Plus d'informations dans l'onglet "Projets")</p>
                        <h1>Mon Parcours Scolaire</h1>
                            <h3>Brevet des collèges (2019)</h3>
                                <p>École privée Bon Accueil, France, Toulon, Var.</p>
                            <h3>Baccalauréat (2022)</h3>
                                <p> Baccalauréat général, option Math / Numérique et Sciences Informatiques. Lycée public Dumont d’Urville, France, Toulon, Var. </p>
                            <h3> BTS SIO Option SLAM (SEPT. 2022 – SEPT. 2024)</h3>
                                <p> BTS SIO option solutions logicielles et applications metiers, lycée public Bonaparte en alternance, France, Toulon, Var. </p>
                    </div>
                </div>
            </div>
            ...
            <div class="containercv2">
                <div class="modal-wrapper">
                    <div class="modal-header">
                        ...
                        <div class="flex-center">
                            <div>MesCompetences</div>
                            <div>-project.html</div>
                        </div>
                    </div>
                    <div class="w-embed modal-body">
                        <h1>Compétences Acquises</h1>
                        <img class="competences" src="../images/Competences.png" />
                    </div>
                </div>
            </div>
